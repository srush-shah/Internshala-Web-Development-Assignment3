...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 21, 2020 at 04:12 PM
...
ALTER TABLE `users_items`
  ...
  ADD CONSTRAINT `users_items_ibfk_2` FOREIGN KEY (`items_id`) REFERENCES `items` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
